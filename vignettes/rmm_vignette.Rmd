...
```{r}
rmm1=rmmTemplate(useCase='apObligate') #  Make an empty rmm object containing only the obligate set of fields.
str(rmm1)
```

A more complex `rmm` object with all predefined fields.
```{r}
rmm2=rmmTemplate(useCase='apAll')
str(rmm2)
```
