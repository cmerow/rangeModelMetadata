...
To run all the available checks at once, we'll check the object that we filled in a few chunks back. (Note that this is commented out because it's an interactive function that asks the user to input responses.)
```{r}
