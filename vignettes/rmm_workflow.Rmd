...
```{r}
# run ENMeval
e <- ENMevaluate(occs, bg.ext, bg, method='block', RMvalues=1:3, fc=c('L','LQ'), algorithm='maxnet')
```
...
#rmm=rmmAutofillPrediction(rmm,transfer=0) 
#rmm=rmmAutofillPrediction(rmm,transfer=1)
